...
<div class="content-wrap">
                            ...
                            <div class="card">
                                <div class="input-group">
                                	<div class="col-lg-12 d-flex justify-content-end">
	                                	<form action="/univ/admin/listEmp.do">
	                                		<div class="row">
	                                			<div>
								...
								<nav class="justify-content-center d-flex">
									...
									<form id="pageFrm" action="/univ/admin/listEmp.do" method="get">
    ...
    <script type="text/javascript">
		...
		$('#noticeListT tr').click(function(){
			location.href="/univ/admin/selectEmp.do?id="+$(this).attr('id');
		});
    </script> 
</body>
</html>