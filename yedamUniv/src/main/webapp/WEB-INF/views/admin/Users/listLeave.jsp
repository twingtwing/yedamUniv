...
<div class="content-wrap">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li id="rest" class="nav-item">
                                            <a class="nav-link active" href="/univ/admin/listLeave.do">
                                            ...
                                            <div class="p-20"><br>
                                                <div class="input-group">
                                                	<div class="col-lg-12 d-flex justify-content-end">
	                                                    <form action="/univ/admin/listLeave.do" method="get">
	                                                    	<div class="row">
	                                                    		<div>
	                                                    		...
	                                                    		<div>
				                                                    <select class="btn btn-default dropdown-toggle mr-1" name="leaveProcess" style="width: 120px; height: 38px;">
                                                    ...
                                                    <tbody>
                                                    	<c:forEach items="${list }" var="leave">
	                                                        <tr id="${leave.leaveNo }">
	                                                            ...
	                                                            <c:if test="${leave.leaveProcess eq 'N' }"><td>승인대기</td></c:if>
	                                                            <c:if test="${leave.leaveProcess eq 'P' }"><td class="font-weight-bold">교수승인</td></c:if>
	                                                            <c:if test="${leave.leaveProcess eq 'C' }"><td>최종승인</td></c:if>
	                                                        </tr>
                                                    	</c:forEach>
                                                        <!--승인대기 > 교수승인 > 최종승인(관리자) -->
                                                ...
                                                <div class="row d-flex justify-content-center">
													...
													<form id="pageFrm" action="/univ/admin/listLeave.do" method="get">
    ...
    <script type="text/javascript">
		...
		$('#noticeListT tr').click(function(){
			location.href="/univ/admin/selectRest.do?leaveNo="+$(this).attr('id');
