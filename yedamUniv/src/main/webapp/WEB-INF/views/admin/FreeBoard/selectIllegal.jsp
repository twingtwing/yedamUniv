...
<!-- ================= Favicon ================== -->
    ...
    <style>
        #delebtn,#savebtn{float: right; color:red;}
        #delebtn:hover,#savebtn:hover{cursor: pointer; font-weight: bold;}
    </style>
</head>
<body>
<div class="content-wrap">
                ...
                <div class="row">
                        <div class="page-header">
                            <div class="page-title">
                                ...
                                <span> 신고게시글관리</span>
                                <h1 class="ti-heart-broken"> 신고게시글조회</h1>
                            </div>
                        </div>
                </div>
                <!-- /# row -->
                                ...
                                <div class="bootstrap-data-table-panel">
                                    <form action="#">
                                        <div class="table-responsive">
                                            <br>
                                            <h2>세상아 덤벼라</h2>
                                            <span id="writer">이말년 YYYY-MM-DD HH:MM 조회 ??</span>
                                            <hr class="one">
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            ...
                                            凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸凸<br/>
                                            <br><br><br>
                                            <span id="delebtn" class="ti-na"> 비공개</span><br>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        document.querySelector("#delebtn").onclick = function(){
