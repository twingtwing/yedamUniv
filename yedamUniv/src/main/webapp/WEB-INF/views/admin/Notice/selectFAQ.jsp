...
<!-- ================= Favicon ================== -->
    ...
    <style>
        #delebtn:hover,#modibtn:hover{cursor: pointer;}
        #modibtn{float: right;}
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="bootstrap-data-table-panel">
                                        <div class="table-responsive">
                                            ...
                                            <br><br><br>
                                            <span id="delebtn" class="ti-trash">삭제</span><span id="modibtn" class="ti-eraser">수정&nbsp;&nbsp;</span>
                                            <br>
                                        </div>
                                </div>
                            </div>
                            ...
                            style="position:absolute; right:0; margin-right: 15px;"> 목록</button><br><br><br>
                            <!-- /# card -->
                        </div>
                        <!-- /# column -->
                    </div>
