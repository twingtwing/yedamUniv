...
<html>
  <head>
    <meta charset="UTF-8" />
    <link href="/univ/resources/mypage/vendors/summernote/dist/summernote-lite.css" rel="stylesheet" />
    <script src="/univ/resources/mypage/vendors/summernote/dist/summernote-lite.js"></script>
    <script src="/univ/resources/mypage/vendors/summernote/dist/lang/summernote-ko-KR.js"> </script>
    ...
    <div class="page-content fade-in-up">
      <div class="row">
        <div class="col-lg-12">
          ...
          <i class="fa fa-angle-right mx-1"></i>
          <a
            href="/univ/pro/mySubDetail.do?subNo=${subNo }"
            alt="my subject"
            class="back_link"
      ...
      <div class="row pt-2">
        <div class="col-lg-12">
          <div class="ibox">
            <div class="ibox-body">
              <form id="bsFrm" method="post" action="/univ/pro/boardInsertForm.do">
