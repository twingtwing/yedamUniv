...
<div class="page-content fade-in-up main_bar">
            ...
            <div class="row mt-5">
                <div class="col-lg-12">
                    <h4 style="font-weight: 600;"><i class="fa fa-chevron-circle-right m-r-10 m-b-10" style="color:var(--blue)" ></i>댓글관리</h4>
                </div>
            </div>
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="/univ/stu/myComment.do">자유댓글</a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/univ/stu/myQna.do" >묻고답하기</a>
                                              ...
                                              <table class="table list-table mt-4 text-center">
                                                <thead class="list-thead">
                                                  <tr>
                                                    ...
                                                    <th class="text-center"  width="40%">댓글내용</th>
