...
<div class="page-content fade-in-up">
  <div class="row">
    ...
    >
      ...
      <i class="fa fa-chevron-right"></i>
      <span class="m-l-10 m-r-10">성적이의신청</span>
      <i class="fa fa-chevron-right"></i>
      <span class="m-l-10 main_bar_span">성적이의답변</span>
    </div>
  </div>
            ...
            <div class="m-2">
              <div class="row mt-3">
                ...
                <div class="d-flex align-items-end ml-3">
                  <h4 class="mb-0 font-weight-bold"><i class="fa fa-lg fa-chevron-circle-right m-r-10 m-b-10"
                    style="color: var(--blue)"></i>성적이의신청</h4>
                </div>
              </div>
              ...
              <div class="row mt-4 pb-2 bg-silver-100">
                <div class="col-lg-12">
                  ...
                  <div class="row mx-2 mt-5 mb-3 d-flex justify-content-start">
                    <button
