	...
	<div id="overviews" class="section wb" style="background-color: #F2F2F2;">
		<div class="container">			
			...
			<div class="comment-form-main">
				<form id="freeboardinsertform" action="/univ/freeboard/freeBoardResister.do" method="post">
					<div class="row">						
						<div class="col-md-12">
							<div class="form-group">
								<input class="form-control" id="cTitle" name="cTitle" placeholder="제목" type="text">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<textarea class="form-control" id="cContents" name="cContents" style="height: 50vh;" placeholder="내용" cols="30" rows="2"></textarea>
							</div>
						</div>						
